      ...
      <div className='flex h-full items-center justify-center space-y-6 sm:px-6 md:px-8'>
        <div className='flex w-full flex-col gap-6 p-6 sm:max-w-lg'>
          ...
          <div>
            ...
            <p className='text-muted-foreground'>Wählen Sie Ihre Anmeldemethode:</p>
          </div>

          <div className='flex flex-wrap gap-4 sm:gap-6'>
            <Button variant='outline' className='grow' onClick={handleGoogleLogin}>
              Mit Google anmelden
            </Button>
            <Button variant='outline' className='grow' onClick={handleFacebookLogin}>
        ...
        <Card className='bg-primary relative h-full justify-between overflow-hidden border-none py-8'>
          <CardHeader className='gap-6 px-8'>
            <CardTitle className='text-primary-foreground text-4xl font-bold xl:text-5xl/15.5'>
              Willkommen bei esysync - Ihrem Display-Support für Immobilienprofis
            </CardTitle>
            <p className='text-primary-foreground text-xl'>
              Melden Sie sich an, um Ihre Support-Anfragen zu verwalten und den Status Ihrer Tickets einzusehen.
            </p>
          </CardHeader>
          ...
          <CardContent className='relative z-1 mx-8 h-62 overflow-hidden rounded-2xl px-0'>
            ...
            <div className='flex flex-col gap-5 p-6'>
              <p className='line-clamp-2 pr-12 text-3xl font-bold'>Schneller Support für Ihre Displays</p>
              <p className='line-clamp-2 text-lg'>
                Ob Schaufenster-Display oder Bankfiliale - wir helfen Ihnen bei allen technischen Problemen.
              </p>
              ...
              <div className='flex -space-x-4 self-end'>
                ...
                <Avatar className='ring-background size-12 ring-2'>
                  <AvatarFallback className='text-xs'>+500</AvatarFallback>
                </Avatar>
              </div>
            </div>
          </CardContent>
